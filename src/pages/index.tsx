    ...
    <>
      ...
      <header className={styles.header}>
        ...
        <nav className={styles.nav}>
          <a href="https://github.com/bw3sley" aria-label="Acessar GitHub">
      ...
      <main>
        <article className={styles.content}>
          <header>
            ...
            <em>Protocolos e diretrizes orientam o desenvolvimento de tecnologias acessíveis, mas é preciso olhar para além de tudo isso</em>
          </header>
